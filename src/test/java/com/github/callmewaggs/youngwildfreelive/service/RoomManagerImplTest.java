...
class RoomManagerImplTest {
  ...
  public void return_room_list_when_room_exist() {
    ...
    List<Room> rooms = Arrays.asList(
        new Room("room1",
            new User(1L, "test", "test", "test", "test", "test", LocalDateTime.now()),
            Category.GAME, LocalDateTime.now(), new ArrayList<>()),
        new Room("room2",
            new User(2L, "test", "test", "test", "test", "test", LocalDateTime.now()),
            Category.EAT, LocalDateTime.now(), new ArrayList<>())
    );
